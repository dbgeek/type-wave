...
//! manual commit). Portable half of the prototype: this module knows the OpenAI
//! protocol and owns the websocket; it is the piece worth graduating into the
//! real skeleton. It knows nothing about CoreAudio or the terminal.
//!
