...
//! knows nothing about the websocket or OpenAI. Chunks are handed to a
//! caller-supplied sink.
//!
//! Graduated verbatim from prototypes/cli-dictation/src/audio.zig (wayfinder #8),
//! renamed audio.zig -> capture.zig to match the CONTEXT.md term (Capture).
